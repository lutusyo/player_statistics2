...
from tagging_app.views.merged import tagging_merged_view
...
urlpatterns = [
    ...
    path(
    'match/<int:match_id>/tagging-merged/', tagging_merged_view, name='tagging_merged_dashboard'),
    ...
    path(
    "match/<int:match_id>/api/outcome-counts/",
    attempt_to_goal.get_outcome_counts,
    name="get_outcome_counts"
),
