...
from matches_app.views import substitution, career_stage, fixture_view, get_match_goals, match_detail, match_lineup, player_statistics, result_view, table_view, team_dashboard



from matches_app.views.substitution import (
    substitution_panel,
    api_get_lists,
...
urlpatterns = [
    ...
    # lineup
    path('match/<int:match_id>/match-lineup/', match_lineup.match_lineup_view, name='match_lineup'),
    ...
    path('match/<int:match_id>/lineup/', match_lineup.match_lineup_view, name='match_lineup'),
