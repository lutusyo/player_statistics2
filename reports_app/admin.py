...
class ResultAdmin(admin.ModelAdmin):
    list_display = ('date', 'competition', 'venue', 'home_team', 'home_score', 'away_team', 'away_score', 'our_team', 'result')
    list_filter = ('competition', 'home_team', 'away_team', 'our_team', 'result')
    search_fields = ('home_team__name', 'away_team__name', 'competition', 'venue')
    date_hierarchy = 'date'
    ...
    fieldsets = (
        (None, {
            'fields': (
                'date', 'venue', 'competition', 'home_team', 'away_team', 
