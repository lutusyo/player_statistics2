...
class GPSRecord(models.Model):
    ...
    heart_rate_band_1_duration = models.CharField(blank=True, null=True)
    heart_rate_band_2_duration = models.CharField(blank=True, null=True)
    heart_rate_band_3_duration = models.CharField(blank=True, null=True)
    heart_rate_band_4_duration = models.CharField(blank=True, null=True)
    heart_rate_band_5_duration = models.CharField(blank=True, null=True)
    heart_rate_band_6_duration = models.CharField(blank=True, null=True)
