...
from version1.tagging_app.utils.attempt_to_goal_utils_opp import get_opponent_goals_for_match
from version1.gps_app.utils.gps_match_detail import get_gps_context
from version1.reports_app.utils.stats import get_match_stats
...
def full_match_context_view(request, match_id, our_team_id):
    ...
    return render(request, 'tagging_app/reports/intro_pages/post_match_summary.html', context)
