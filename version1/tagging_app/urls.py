...
from version1.tagging_app.views  import attempt_to_goal, goalkeeper_distribution, pass_network, tagging_view, current_players
from version1.tagging_app import views
from version1.tagging_app.views import current_players

from version1.tagging_app.views.output import full_report, table_of_contents, post_match_summary
from version1.tagging_app.views2 import delivery_type, pdf_download, attempt_summary
from version1.tagging_app.views.shotmaps_csv import download_attempts_csv
