...
from version1.lineup_app.views.lineup_bila_uwanja import  create_lineup_view
from version1.lineup_app.views.match_lineup_view_with_uwanja import pitch_lineup_view
