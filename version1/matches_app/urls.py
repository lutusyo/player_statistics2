...
from version1.matches_app.views import  ( career_stage, fixture_view, get_match_goals, match_detail, player_statistics, result_view, table_view, team_dashboard, result_exports)
